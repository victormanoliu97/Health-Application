...
public class DoctorController {
    ...
    @GetMapping(value = "/{id}")
    public Doctor getDoctor(@PathVariable("id") int id) throws NotFoundException {
    ...
    @PutMapping(value = "/{id}")
    public Doctor updateDoctor(@PathVariable("id") int id, @RequestBody Doctor doctor) throws BadRequestException, NotFoundException {
        //validate request
        if (id == doctor.getId()) {
